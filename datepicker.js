;(function (window, $, undefined) { ;(function () {
        ...
        defaults = {
			...
			onSlap: function onSlap(dateText, inst){ 
                 ...
                 //  console.log('in:' + dateText);
				   ...
				   apex.event.trigger(document,'meonSlap',extraParams);
    ...
    datepicker.prototype = {
        ...
        init: function () {
			...
			this.$el.on('onSelect', this._onSelect.bind(this));
			this.$datepicker.on('onSelect', this._onSelect.bind(this));
            
			this.$el.on('onSelect', function(o, record, index){
            ...
            this.$datepicker.on('onSelect', function(o, record, index){
			 ...
			 this.$el.bind('ontest', this._onSelect);
           ...
           $(this).on('_onShowEvent', function(o, record, index){
			...
			//	apex.event.trigger('#' + o.el.id,'dshow');
				
				};
			/*this.opts.onSelect = function(formattedDates, dates,o){
               console.log('ini');
			  // console.log(o.el.id);
			   //console.log(this.$el);
			   
			   apex.jQuery(o).trigger('onSelect');
			  apex.event.trigger(o,'onSelect');
			  //apex.jQuery('#' + o.el.id).trigger('onSelect');
			  //apex.event.trigger('#' + o.el.id,'onSelect');
                 };
			/*this.$datepicker.on('onSelect', function(formattedDates, dates){
               console.log('ini');
			   //console.log(o);
			   console.log(this.id);
			   
			   
			  apex.jQuery('#' + this.id).trigger('onSelect');
                 });
           this.$datepicker.on('onSelect', function(formattedDates, dates){
               console.log('mini');
			   //console.log(o);
			 ...
			 // apex.jQuery('#' + this.id).trigger('onSelect');
				  ...
				  this.$el.on('onSelect', function(formattedDates, dates){
               console.log('ini');
			   //console.log(o);
			    console.log(this.id);
			    console.log(this.el.id);
		     // apex.jQuery('#' + this.el.id).trigger('onSelect');
