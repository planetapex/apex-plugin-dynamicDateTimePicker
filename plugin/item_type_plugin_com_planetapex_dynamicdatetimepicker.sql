...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(4048984742297137)
...
'  v_temp_format := replace(v_temp_format, ''DAY'', ''D''); --MON -> Mon',
'  v_temp_format := replace(v_temp_format, ''Day'', ''D''); --Mon -> Mon',
...
'  v_temp_format := replace(v_temp_format, ''MI'', ''ii'');',
'  v_temp_format := replace(v_temp_format, ''SS'', '''');',
...
'  v_temp_format := replace(v_temp_format, ''AM'', '' aa'');',
'  v_temp_format := replace(v_temp_format, ''PM'', '' aa'');',
...
'  --przetlumacz wyjatki',
'  v_temp_format := replace(v_temp_format, ''MONTH'', ''MM''); --JANUARY -> January',
'  v_temp_format := replace(v_temp_format, ''fmMonth'', ''MM''); --January -> January',
'  v_temp_format := replace(v_temp_format, ''Month'', ''MM''); --January -> January',
'  v_temp_format := replace(v_temp_format, ''MON'', ''M''); --JAN -> Jan',
'  v_temp_format := replace(v_temp_format, ''Mon'', ''M''); --Jan -> Jan',
'  v_temp_format := replace(v_temp_format, ''HH24'', ''hh'');',
...
'  return v_temp_format;',
'end;',
'FUNCTION F_RENDER_DATEPICKER(P_ITEM IN APEX_PLUGIN.T_PAGE_ITEM, P_PLUGIN IN APEX_PLUGIN.T_PLUGIN, P_VALUE IN VARCHAR2, P_IS_READONLY IN BOOLEAN, P_IS_PRINTER_FRIENDLY IN BOOLEAN)',
...
'  v_jquery_base_toItem varchar2(200);',
...
'  v_firstDay apex_appl_plugins.attribute_03%type := p_item.attribute_03;',
'  v_weekends apex_appl_plugins.attribute_04%type := p_item.attribute_04;',
...
'  v_minmaxHoursMins apex_appl_plugins.attribute_07%type := p_item.attribute_07;',
'  v_showMethod apex_appl_plugins.attribute_08%type := p_item.attribute_08;',
'  v_multipleDatesSeparator apex_appl_plugins.attribute_09%type := p_item.attribute_09;',
'  v_dateTimeSeparator apex_appl_plugins.attribute_10%type := p_item.attribute_10;',
'  v_timepicker apex_appl_plugins.attribute_11%type := p_item.attribute_11;',
'  v_position apex_appl_plugins.attribute_12%type := lower(p_item.attribute_12);',
'  v_navTitles apex_appl_plugins.attribute_13%type := p_item.attribute_13;',
'  v_options apex_appl_plugins.attribute_14%type := p_item.attribute_14;',
'  v_language p_plugin.attribute_03%type := p_plugin.attribute_03;',
'  v_Navigation p_plugin.attribute_04%type := p_plugin.attribute_04;',
'  v_Navigation_Size p_plugin.attribute_05%type := p_plugin.attribute_05;',
'  att_orcl_date_format_mask p_item.format_mask%type := nvl(p_item.format_mask, sys_context(''userenv'', ''nls_date_format''));',
'  att_js_date_format_mask p_item.format_mask%type;',
'  att_time_format boolean := case',
'                               when instr(att_orcl_date_format_mask, ''HH'') > 0 then',
'                                true',
'                               else',
'                                false',
'                             end;',
'  att_time_format24 boolean := case',
'                                 when instr(att_orcl_date_format_mask, ''HH24'') > 0 then',
'                                  true',
'                                 else',
'                                  false',
'                               end;',
'  att_time_formatSS boolean := case',
'                                 when instr(att_orcl_date_format_mask, ''SS'') > 0 then',
'                                  true',
'                                 else',
'                                  false',
'                               end;',
...
'  v_opt APEX_APPLICATION_GLOBAL.VC_ARR2;',
'  v_reg_chk Integer;',
'  v_minmax APEX_APPLICATION_GLOBAL.VC_ARR2;',
'  v_mins APEX_APPLICATION_GLOBAL.VC_ARR2;',
'  v_maxs APEX_APPLICATION_GLOBAL.VC_ARR2;',
'  v_minHour INTEGER;',
'  v_maxHour INTEGER;',
'  v_minMin INTEGER;',
'  v_maxMin INTEGER;',
...
'  v_date date;',
'  v_frmt_cnt integer;',
'  v_date_frmt varchar2(200);',
'  v_time_frmt varchar2(200);',
'  l_err_msg varchar2(255);',
'  v_ui_chk CHAR(1);',
'  v_ver_chk CHAR(1);',
'BEGIN',
'    SELECT case',
'             when t.version_no like ''5.0%'' then',
'              ''Y''',
'             when t.version_no like ''4%'' then',
'              ''Y''',
'             else',
'              ''N''',
'           end Ver',
...
'            ''%ERROR_PREFIX% "'' || pa_ci.prompt ||',
'            ''" must be a different page item (can''''t be the same as self).''',
'           when pi_org.attribute_01 = 2 and pi_other.item_name is null then',
'            ''%ERROR_PREFIX% "'' || pa_ci.prompt ||',
'            ''" item (%OTHER_ITEM_NAME%) does not exist''',
'           else',
'            null',
'         end err_msg',
'    into l_err_msg',
'    from apex_application_page_items pi_org, apex_application_page_items pi_other, apex_appl_plugin_attributes pa_ci',
'   where 1 = 1 and pi_org.application_id = apex_application.g_flow_id and',
'         pi_org.item_name = p_item.name and',
'         pi_org.application_id = pi_other.application_id(+) and',
'         Upper(pi_org.attribute_02) = pi_other.item_name(+) and',
'         pa_ci.application_id = pi_org.application_id and',
'         upper(pi_org.display_as_code) =',
'         upper(''PLUGIN_'' || pa_ci.plugin_name) and',
'         pa_ci.attribute_sequence = 2 and',
'         pa_ci.attribute_scope = ''Component'';',
'  if l_err_msg is not null then',
'    l_err_msg := replace(l_err_msg, ''%ERROR_PREFIX%'', ''%ITEM_NAME%:'');',
'    l_err_msg := replace(l_err_msg, ''%ITEM_NAME%'', p_item.name);',
'    l_err_msg := replace(l_err_msg, ''%OTHER_ITEM_NAME%'', v_To_date_item_Name);',
'    wwv_flow.show_error_message(p_message => ''--Configuration Error-- '', p_footer => l_err_msg);',
'  end if;',
'  IF APEX_APPLICATION.G_DEBUG THEN',
'    APEX_PLUGIN_UTIL.DEBUG_PAGE_ITEM(P_PLUGIN => P_PLUGIN, P_PAGE_ITEM => P_ITEM, P_VALUE => P_VALUE, P_IS_READONLY => P_IS_READONLY, P_IS_PRINTER_FRIENDLY => P_IS_PRINTER_FRIENDLY);',
'  END IF;',
...
'     where Upper(t.is_default) = ''YES'' and t.application_id = v_app_id;',
'    if v_showMethod != ''inline'' AND v_ui_chk = ''Y'' then',
'      V_HTML := V_HTML ||',
'                ''<button type="button" class="dyndatepicker-trigger a-Button a-Button--calendar">'' ||',
...
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''dateToItem'', v_To_date_item_Name);',
'      WHEN 3 THEN',
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''multipleDates'', 100);',
'        if v_multipleDatesSeparator IS NOT NULL THEN',
'          V_HTML := V_HTML ||',
'                    apex_javascript.add_attribute(''multipleDatesSeparator'', v_multipleDatesSeparator);',
'        END IF;',
'      WHEN 4 THEN',
'        V_HTML := V_HTML || apex_javascript.add_attribute(''view'', ''months'');',
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''minView'', ''months'');',
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''autoClose'', true);',
'      WHEN 5 THEN',
'        V_HTML := V_HTML || apex_javascript.add_attribute(''view'', ''months'');',
...
'                  apex_javascript.add_attribute(''multipleDates'', 100);',
'      WHEN 7 THEN',
'        V_HTML := V_HTML || apex_javascript.add_attribute(''view'', ''years'');',
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''minView'', ''years'');',
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''autoClose'', true);',
'      WHEN 8 THEN',
'        V_HTML := V_HTML || apex_javascript.add_attribute(''view'', ''years'');',
...
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''todayBtnText'', ''Now'');',
'      WHEN 11 THEN',
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''autoClose'', true);',
'        V_HTML := V_HTML ||',
...
'                  apex_javascript.add_attribute(''timepicker'', true);',
'        V_HTML := V_HTML ||',
'                  apex_javascript.add_attribute(''dateTimeSplit'', true);',
'    END CASE;',
'    if v_multipleDatesSeparator IS NOT NULL THEN',
'      V_HTML := V_HTML ||',
'                apex_javascript.add_attribute(''multipleDatesSeparator'', v_multipleDatesSeparator);',
'    END IF;',
'    if v_dateTimeSeparator IS NOT NULL OR v_date_picker_type = 11 THEN',
'      V_HTML := V_HTML ||',
'                apex_javascript.add_attribute(''dateTimeSeparator'', '' ^'' ||',
'                                               v_dateTimeSeparator || ''^ '');',
'    END IF;',
'    IF v_timepicker = ''Y'' THen',
'      V_HTML := V_HTML || apex_javascript.add_attribute(''timepicker'', true);',
'      IF v_minmaxHoursMins is Not NUll Then',
'        Select Count(*)',
'          into v_reg_chk',
'          from dual',
'         Where regexp_like(v_minmaxHoursMins, ''^[0-9]{2}:[0-9]{2},[0-9]{2}:[0-9]{2}'');',
'        IF v_reg_chk = 1 Then',
'          v_minmax := APEX_UTIL.STRING_TO_TABLE(v_minmaxHoursMins, '','');',
'          v_mins := APEX_UTIL.STRING_TO_TABLE(v_minmax(1), '':'');',
'          v_maxs := APEX_UTIL.STRING_TO_TABLE(v_minmax(2), '':'');',
'          V_HTML := V_HTML ||',
'                    apex_javascript.add_attribute(''minHours'', TO_NUMBER(v_mins(1)));',
'          V_HTML := V_HTML ||',
'                    apex_javascript.add_attribute(''maxHours'', TO_NUMBER(v_maxs(1)));',
'          V_HTML := V_HTML ||',
'                    apex_javascript.add_attribute(''minMinutes'', TO_NUMBER(v_mins(2)));',
'          V_HTML := V_HTML ||',
'                    apex_javascript.add_attribute(''maxMinutes'', TO_NUMBER(v_maxs(2)));',
'        Else',
'          wwv_flow.show_error_message(p_message => ''--Configuration Error in Hours:Minutes Minimum,Maximum value-- '', p_footer => v_minmaxHoursMins ||',
'                                                   '' is not a valid value. Provide a value in as "00:00,23:59" .Refer to the Property Help.'');',
'        End if;',
'      End if;',
'    End if;',
'    BEGIN',
'       V_STMNT := q''[begin :val :=TO_CHAR(SYSDATE,'']'' ||',
'                   att_orcl_date_format_mask || ''''''); end;'';',
'        EXECUTE IMMEDIATE V_STMNT',
'          USING OUT v_date_str;',
'    Exception',
'      when Others then',
'        wwv_flow.show_error_message(p_message => ''--Configuration Error in Format Mask-- '', p_footer => att_orcl_date_format_mask ||',
'                                                 '' Format Mask is invalid. Provide a valid date format'');',
'    END;',
'    v_date_frmt := translateOracleJs(Trim(substr(att_orcl_date_format_mask, 0, case',
'                                                   att_time_format',
'                                                    when',
'                                                     FALSE then',
'                                                     length(att_orcl_date_format_mask)',
'                                                    else',
'                                                     Instr(UPPER(att_orcl_date_format_mask), ''HH'') - 1',
'                                                  end)));',
'    V_HTML := V_HTML ||',
'              apex_javascript.add_attribute(''dateFormat'', v_date_frmt);',
'    v_time_frmt := translateOracleJs(Trim(substr(att_orcl_date_format_mask, case',
'                                                   att_time_format',
'                                                    when',
'                                                     FALSE then',
'                                                     length(att_orcl_date_format_mask) + 1',
'                                                    else',
'                                                     Instr(UPPER(att_orcl_date_format_mask), ''HH'')',
'                                                  end, length(att_orcl_date_format_mask))));',
'    V_HTML := V_HTML ||',
'              apex_javascript.add_attribute(''timeFormat'', v_time_frmt);',
'    V_HTML := V_HTML ||',
'              apex_javascript.add_attribute(''firstDay'', to_number(v_firstDay));',
'    if v_weekends IS NOT NULL THEN',
'      V_HTML := V_HTML ||',
'                apex_javascript.add_attribute(''weekends'', ''['' ||',
'                                               replace(v_weekends, '':'', '','') || '']'');',
'    END IF;',
...
'    END IF;',
'    if v_showMethod = ''inline'' then',
'      V_HTML := V_HTML || apex_javascript.add_attribute(''inline'', true);',
'    else',
'      V_HTML := V_HTML ||',
'                apex_javascript.add_attribute(''showMethod'', v_showMethod);',
'    end if;',
'    V_HTML := V_HTML ||',
...
'      V_HTML := V_HTML ||',
'                apex_javascript.add_attribute(''classes'', p_item.element_css_classes);',
'    end if;',
'    v_tk := APEX_UTIL.STRING_TO_TABLE(v_options);',
'    aar_opts := ass_tab(''toggleSelected'', ''autoClose'', ''keyboardNav'', ''todayButton'', ''clearButton'', ''showOtherMonths'', ''selectOtherMonths'', ''moveToOtherMonthsOnSelect'', ''showOtherYears'', ''selectOtherYears'', ''moveToOtherYearsOnSelect'', ''disableNavWhen'
||'OutOfRange'');',
'    FOR i IN 1 .. v_tk.count LOOP',
'      aar_sels.extend;',
'      aar_sels(i) := aar_opts(to_NUMBER(v_tk(i)));',
'    END LOOP;',
'    aar_unsels := aar_opts MULTISET except aar_sels;',
'    l_idx := aar_sels.first;',
'    while (l_idx is not null) loop',
'      IF aar_opts(l_idx) = ''todayButton'' then',
'        V_HTML := V_HTML || ''"todayButton": new Date(),'';',
'      ELSE',
'        V_HTML := V_HTML ||',
...
'    while (l_idx is not null) loop',
'      V_HTML := V_HTML ||',
'                apex_javascript.add_attribute(aar_unsels(l_idx), false);',
'      l_idx := aar_unsels.next(l_idx);',
'    end loop;',
'    if v_language != ''en'' then',
'      APEX_JAVASCRIPT.ADD_LIBRARY(P_NAME => ''datepicker.'' || v_language, P_DIRECTORY => p_plugin.file_prefix ||',
'                                                  ''/js/i18n/'', P_VERSION => NULL);',
'    end if;',
'    V_HTML := V_HTML ||',
'              apex_javascript.add_attribute(''language'', v_language);',
'    IF v_Navigation = ''dent'' THEN',
'      V_HTML := V_HTML || ''"prevHtml":"<span class=''''fa fa-dedent '' ||',
'                v_Navigation_Size || ''''''></span>",'';',
'      V_HTML := V_HTML || ''"nextHtml":"=<span class=''''fa fa-indent '' ||',
'                v_Navigation_Size || ''''''></span>",'';',
'    ELSIF v_Navigation != ''def'' THEN',
'      V_HTML := V_HTML || ''"prevHtml":"<span class=''''fa '' || v_Navigation ||',
'                ''-left '' || v_Navigation_Size || ''''''></span>",'';',
'      V_HTML := V_HTML || ''"nextHtml":"<span class=''''fa '' || v_Navigation ||',
'                ''-right '' || v_Navigation_Size || ''''''></span>",'';',
'    END IF;',
'    V_HTML := V_HTML || apex_javascript.add_attribute(''desktopUI'', case',
...
'                                                       end);',
'    V_HTML := V_HTML ||',
'              apex_javascript.add_attribute(''dateItemID'', P_ITEM.NAME, p_omit_null => FALSE, p_add_comma => FALSE);',
'    if v_showMethod = ''inline'' AND v_ui_chk != ''Y'' then',
'      V_HTML := ''apex.jQuery("'' || v_jquery_base_item ||',
'                ''_CONTAINER").dynamicDateTimePicker({'' || V_HTML || ''}); '';',
'   elsif v_showMethod = ''inline'' AND v_ui_chk =''Y'' AND v_ver_chk =''N'' Then',
'        V_HTML := ''apex.jQuery("'' || v_jquery_base_item ||',
'                  ''").parent("div").parent("div").dynamicDateTimePicker({'' || V_HTML ||',
'                  ''}); '';',
'    else',
'      V_HTML := ''apex.jQuery("'' || v_jquery_base_item ||',
'                ''").dynamicDateTimePicker({'' || V_HTML || ''}); '';',
'    end if;',
'    APEX_JAVASCRIPT.ADD_ONLOAD_CODE(P_CODE => V_HTML, p_key => ''dynamicDateTimePicker_'' ||',
'                                              p_item.name);',
'    V_RESULT.IS_NAVIGABLE := TRUE;',
'  END IF;',
'  RETURN V_RESULT;',
'END F_RENDER_DATEPICKER;',
'FUNCTION f_validate_datepicker(p_item IN apex_plugin.t_page_item, p_plugin IN apex_plugin.t_plugin, p_value IN VARCHAR2)',
'  RETURN apex_plugin.t_page_item_validation_result AS',
'  v_result apex_plugin.t_page_item_validation_result;',
'  V_APP_ID APEX_APPLICATIONS.APPLICATION_ID%TYPE := apex_application.g_flow_id;',
'  V_PAGE_ID APEX_APPLICATION_PAGES.PAGE_ID%TYPE := apex_application.g_flow_step_id;',
'  attr_app_valdtn_chk p_plugin.attribute_01%type := p_plugin.attribute_01;',
'  attr_app_valdtn_pos p_plugin.attribute_02%type := p_plugin.attribute_02;',
'  v_date_picker_type apex_application_page_items.attribute_01%type := p_item.attribute_01;',
'  v_other_item apex_application_page_items.attribute_02%type := upper(p_item.attribute_02);',
'  v_other_label apex_application_page_items.label%type;',
'  v_other_item_val varchar2(255);',
'  att_orcl_date_format_mask apex_application_page_items.format_mask%type := nvl(p_item.format_mask, sys_context(''userenv'', ''nls_date_format''));',
'  v_date date;',
'  att_other_orcl_date_format apex_application_page_items.format_mask%type;',
'  v_other_date date;',
'  att_time_format boolean := case',
'                               when instr(att_orcl_date_format_mask, ''HH'') > 0 then',
'                                true',
...
'  v_time_frmt varchar2(200);',
'BEGIN',
'  if attr_app_valdtn_chk = ''Y'' THEN',
'    IF apex_application.g_debug THEN',
'      apex_plugin_util.debug_page_item(p_plugin => p_plugin, p_page_item => p_item, p_value => p_value, p_is_readonly => FALSE, p_is_printer_friendly => FALSE);',
'    END IF;',
'    IF attr_app_valdtn_pos = ''FN'' THEN',
'      v_result.display_location := apex_plugin.c_inline_with_field_and_notif;',
'    ELSIF attr_app_valdtn_pos = ''F'' THEN',
'      v_result.display_location := apex_plugin.c_inline_with_field;',
'    ELSIF attr_app_valdtn_pos = ''N'' THEN',
'      v_result.display_location := apex_plugin.c_inline_in_notification;',
'    ELSIF attr_app_valdtn_pos = ''E'' THEN',
'      v_result.display_location := apex_plugin.c_on_error_page;',
'    end if;',
'    IF p_value IS NULL THEN',
'      RETURN v_result;',
'    END IF;',
'    IF v_date_picker_type = 11 THEN',
'      v_date_frmt := Trim(substr(att_orcl_date_format_mask, 0, case',
'                                   att_time_format',
'                                    when FALSE then',
'                                     length(att_orcl_date_format_mask)',
'                                    else',
...
'                                  end));',
'      IF NOT',
'          wwv_flow_utilities.is_date(p_date => p_value, p_format => v_date_frmt) THEN',
'        v_result.message := ''#LABEL# Invalid date.Date must be in '' ||',
'                            v_date_frmt || '' format Mask'';',
'        RETURN v_result;',
'      ELSE',
'        BEGIN',
'          v_date := to_date(p_value, v_date_frmt);',
'        Exception',
'          when Others then',
'            v_result.message := ''#LABEL# Invalid date.Date must be in '' ||',
'                                v_date_frmt || '' format Mask'';',
...
'         WHERE application_id = v_app_id AND page_id = v_page_id AND',
'               item_name = upper(v_other_item);',
'        v_other_item_val := v(v_other_item);',
'        v_time_frmt := Trim(substr(att_orcl_date_format_mask, case',
'                                     att_time_format',
'                                      when FALSE then',
'                                       length(att_orcl_date_format_mask) + 1',
'                                      else',
'                                       Instr(UPPER(att_orcl_date_format_mask), ''HH'')',
'                                    end, length(att_orcl_date_format_mask)));',
'        IF wwv_flow_utilities.is_date(p_date => v_other_item_val, p_format => v_time_frmt) THEN',
'          v_other_date := to_date(v_other_item_val, v_time_frmt);',
'        ELSE',
'          v_result.message := v_other_label ||',
'                              '' is an invalid Time.Time must be in '' ||',
'                              v_time_frmt || '' format Mask'';',
'          v_result.page_item_name := v_other_item;',
'          RETURN v_result;',
'        END IF;',
'      END IF;',
...
'    ELSE',
'      IF NOT',
'          wwv_flow_utilities.is_date(p_date => p_value, p_format => att_orcl_date_format_mask) THEN',
'        v_result.message := ''#LABEL# Invalid date.Date must be in '' ||',
'                            att_orcl_date_format_mask || '' format Mask'';',
'        RETURN v_result;',
'      ELSE',
'        BEGIN',
'          v_date := to_date(p_value, att_orcl_date_format_mask);',
'        Exception',
'          when Others then',
'            v_result.message := ''#LABEL# Invalid date.Date must be in '' ||',
'                                att_orcl_date_format_mask || '' format Mask'';',
...
'        END;',
'      END IF;',
'      IF v_date_picker_type in (2, 5, 8) THEN',
'        IF LENGTH(v(v_other_item)) > 0 THEN',
'          SELECT MAX(label)',
'            INTO v_other_label',
'            FROM apex_application_page_items',
...
'                 item_name = upper(v_other_item);',
'          v_other_item_val := v(v_other_item);',
'          IF wwv_flow_utilities.is_date(p_date => v_other_item_val, p_format => att_orcl_date_format_mask) THEN',
'            v_other_date := to_date(v_other_item_val, att_orcl_date_format_mask);',
'          ELSE',
'            v_result.message := v_other_label ||',
'                                '' is an invalid date..Date must be in '' ||',
'                                att_orcl_date_format_mask || '' format Mask'';',
'            v_result.page_item_name := v_other_item;',
'            RETURN v_result;',
'          END IF;',
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4542740999858315)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4543910052988042)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'APPLICATION'
...
,p_default_value=>'FN'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(4542740999858315)
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4544666678991572)
,p_plugin_attribute_id=>wwv_flow_api.id(4543910052988042)
,p_display_sequence=>10
,p_display_value=>'Inline with Field and in Notification'
,p_return_value=>'FN'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4545064477992482)
,p_plugin_attribute_id=>wwv_flow_api.id(4543910052988042)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4545451127993512)
,p_plugin_attribute_id=>wwv_flow_api.id(4543910052988042)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4545927283994338)
,p_plugin_attribute_id=>wwv_flow_api.id(4543910052988042)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4549700460091810)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4550467908093012)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
,p_display_sequence=>10
,p_display_value=>'Chinese'
,p_return_value=>'zh'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4550870473095352)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4551316474097610)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4551702117099102)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4552096628100704)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4552535243102340)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4552888831103477)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4553277798104891)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4553657392106340)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4554052969108199)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4554519136109971)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4554845526110749)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4555266827112078)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4555682596112902)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4556084260113940)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4556519375115044)
,p_plugin_attribute_id=>wwv_flow_api.id(4549700460091810)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4561758735208402)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4562584439209505)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'def'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4567409455263664)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4567737904265050)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4562962311220284)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4563435940225118)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4564163063229421)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4566176266256758)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4566548787260583)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4564593691240327)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4565008578242070)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4565370120247999)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4565765939253686)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4566988552262367)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4568234871269920)
,p_plugin_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_display_sequence=>140
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4570304945359725)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'APPLICATION'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(4561758735208402)
,p_depending_on_condition_type=>'NOT_IN_LIST'
,p_depending_on_expression=>'def'
,p_lov_type=>'STATIC'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4571097144361745)
,p_plugin_attribute_id=>wwv_flow_api.id(4570304945359725)
,p_display_sequence=>10
,p_display_value=>'1x'
,p_return_value=>'fa-1x'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4571476308362709)
,p_plugin_attribute_id=>wwv_flow_api.id(4570304945359725)
,p_display_sequence=>20
,p_display_value=>'2x'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4571882927363503)
,p_plugin_attribute_id=>wwv_flow_api.id(4570304945359725)
,p_display_sequence=>30
,p_display_value=>'3x'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4572284818364660)
,p_plugin_attribute_id=>wwv_flow_api.id(4570304945359725)
,p_display_sequence=>40
,p_display_value=>'4x'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4345467876079126)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4346388738080601)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4346837365081451)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4347160267082221)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4347609962083412)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4435688939340316)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4439977472465706)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4440356854467211)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4440804754468842)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4441224677470987)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>90
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4444263899548099)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>100
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4478529332359527)
,p_plugin_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4307555388320165)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(4345467876079126)
,p_depending_on_condition_type=>'IN_LIST'
,p_depending_on_expression=>'2,5,8,11'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4232381101620599)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4232960732625273)
,p_plugin_attribute_id=>wwv_flow_api.id(4232381101620599)
,p_display_sequence=>10
,p_display_value=>'Sunday'
,p_return_value=>'0'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4233396201626114)
,p_plugin_attribute_id=>wwv_flow_api.id(4232381101620599)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4233752484630374)
,p_plugin_attribute_id=>wwv_flow_api.id(4232381101620599)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4234181484631005)
,p_plugin_attribute_id=>wwv_flow_api.id(4232381101620599)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4234600749632323)
,p_plugin_attribute_id=>wwv_flow_api.id(4232381101620599)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4234968305633126)
,p_plugin_attribute_id=>wwv_flow_api.id(4232381101620599)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4235390083634098)
,p_plugin_attribute_id=>wwv_flow_api.id(4232381101620599)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4308896573375041)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4309467379379088)
,p_plugin_attribute_id=>wwv_flow_api.id(4308896573375041)
,p_display_sequence=>10
,p_display_value=>'Saturday'
,p_return_value=>'6'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4309886329379819)
,p_plugin_attribute_id=>wwv_flow_api.id(4308896573375041)
,p_display_sequence=>20
,p_display_value=>'Sunday'
,p_return_value=>'0'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4310271167380490)
,p_plugin_attribute_id=>wwv_flow_api.id(4308896573375041)
,p_display_sequence=>30
,p_display_value=>'Monday'
,p_return_value=>'1'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4310639561381451)
,p_plugin_attribute_id=>wwv_flow_api.id(4308896573375041)
,p_display_sequence=>40
,p_display_value=>'Tuesday'
,p_return_value=>'2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4311128735382113)
,p_plugin_attribute_id=>wwv_flow_api.id(4308896573375041)
,p_display_sequence=>50
,p_display_value=>'Wednesday'
,p_return_value=>'3'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4311490510382718)
,p_plugin_attribute_id=>wwv_flow_api.id(4308896573375041)
,p_display_sequence=>60
,p_display_value=>'Thursday'
,p_return_value=>'4'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4311859098383678)
,p_plugin_attribute_id=>wwv_flow_api.id(4308896573375041)
,p_display_sequence=>70
,p_display_value=>'Friday'
,p_return_value=>'5'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4211251639408362)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4211845230410401)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4318640788533293)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(4315113545468074)
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_examples=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<ul>',
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4416685618618653)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4417154111620367)
,p_plugin_attribute_id=>wwv_flow_api.id(4416685618618653)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4417599872622911)
,p_plugin_attribute_id=>wwv_flow_api.id(4416685618618653)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4418031701629947)
,p_plugin_attribute_id=>wwv_flow_api.id(4416685618618653)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4418352291631143)
,p_plugin_attribute_id=>wwv_flow_api.id(4416685618618653)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4418806429632720)
,p_plugin_attribute_id=>wwv_flow_api.id(4416685618618653)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4419185152633798)
,p_plugin_attribute_id=>wwv_flow_api.id(4416685618618653)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4213646739424775)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4214282513425509)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4315113545468074)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4274923752335171)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4275517172337918)
,p_plugin_attribute_id=>wwv_flow_api.id(4274923752335171)
,p_display_sequence=>10
,p_display_value=>'Bottom Left'
,p_return_value=>'Bottom Left'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4275879086339918)
,p_plugin_attribute_id=>wwv_flow_api.id(4274923752335171)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4276273800341584)
,p_plugin_attribute_id=>wwv_flow_api.id(4274923752335171)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4276679865342886)
,p_plugin_attribute_id=>wwv_flow_api.id(4274923752335171)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4278014048353937)
,p_plugin_attribute_id=>wwv_flow_api.id(4274923752335171)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4278437625355456)
,p_plugin_attribute_id=>wwv_flow_api.id(4274923752335171)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4278768053356268)
,p_plugin_attribute_id=>wwv_flow_api.id(4274923752335171)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4279218240358125)
,p_plugin_attribute_id=>wwv_flow_api.id(4274923752335171)
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4280791735402739)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(4330174424675163)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4330772842676214)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4331236844677161)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>20
,p_display_value=>'Autoclose'
,p_return_value=>'2'
,p_help_text=>'If checked, date picker will close after date selection.'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4331630424678573)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4331967949679690)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4332428061680986)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4332806412681859)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4333192064687954)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4333596021692590)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4334016584778199)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>90
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4334368474782107)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>100
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4334788210788954)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(4335212640793100)
,p_plugin_attribute_id=>wwv_flow_api.id(4330174424675163)
,p_display_sequence=>120
...
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(4074632128547410)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_name=>'onchangedecade'
,p_display_name=>'When Decade Changes'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(4075798808547412)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_name=>'onchangemonth'
,p_display_name=>'When Month Changes'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(4455398729941796)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_name=>'onchangeview'
,p_display_name=>'When View Changes'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(4075364006547412)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_name=>'onchangeyear'
,p_display_name=>'When Year Changes'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(4075008246547411)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_name=>'onhide'
,p_display_name=>'On Hiding'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(4076870275628765)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_name=>'onrendercell'
,p_display_name=>'On Rendering'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(4090627236870360)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_name=>'onselect'
,p_display_name=>'On Selection'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(4076162271628765)
,p_plugin_id=>wwv_flow_api.id(4048984742297137)
,p_name=>'onshow'
...
wwv_flow_api.g_varchar2_table(2) := '302C6461746554696D6553706C69743A21312C73686F774D6574686F643A6E756C6C2C746F64617942746E546578743A6E756C6C2C636C61737365733A22222C696E6C696E653A21312C6C616E67756167653A22656E222C66697273744461793A22222C';
wwv_flow_api.g_varchar2_table(3) := '7765656B656E64733A5B362C305D2C64617465466F726D61743A22222C746F67676C6553656C65637465643A21302C6B6579626F6172644E61763A21302C706F736974696F6E3A22626F74746F6D206C656674222C6F66667365743A31322C766965773A';
wwv_flow_api.g_varchar2_table(4) := '2264617973222C6D696E566965773A2264617973222C73686F774F746865724D6F6E7468733A21302C73656C6563744F746865724D6F6E7468733A21302C6D6F7665546F4F746865724D6F6E7468734F6E53656C6563743A21302C73686F774F74686572';
wwv_flow_api.g_varchar2_table(5) := '59656172733A21302C73656C6563744F7468657259656172733A21302C6D6F7665546F4F7468657259656172734F6E53656C6563743A21302C6D696E446174653A22222C6D6178446174653A22222C64697361626C654E61765768656E4F75744F665261';
wwv_flow_api.g_varchar2_table(6) := '6E67653A21302C6D756C7469706C6544617465733A21312C6D756C7469706C654461746573536570617261746F723A222C222C72616E67653A21312C746F646179427574746F6E3A21312C636C656172427574746F6E3A21312C6175746F436C6F73653A';
wwv_flow_api.g_varchar2_table(7) := '21312C6E61765469746C65733A7B646179733A224D4D2C203C693E797979793C2F693E222C6D6F6E7468733A2279797979222C79656172733A227979797931202D207979797932227D2C74696D657069636B65723A21312C6F6E6C7954696D657069636B';
